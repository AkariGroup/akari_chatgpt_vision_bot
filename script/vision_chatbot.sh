...
cd ../
 ...
 gnome-terminal --title="voicevox_server" -- bash -ic "python3 akari_chatgpt_bot/voicevox_server.py --voice_local --voice_host ${ip}"
 gnome-terminal --title="gpt_vision_publisher" -- bash -ic "python3 gpt_vision_publisher.py"
